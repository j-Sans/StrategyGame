...
//Gameboard:
    ...
    G.gameBoard.setCreature(7, 1, Creature(Human, 1, 2, 1, 1, 1, 1, NORTH, 0));

    G.gameBoard.setCreature(3, 1, Creature(Human, 1, 1, 1, 1, 1, 1, NORTH, 2));
    
    G.gameBoard.setCreature(4, 1, Creature(Human, 1, 1, 2, 1, 1, 1, NORTH, 3));
